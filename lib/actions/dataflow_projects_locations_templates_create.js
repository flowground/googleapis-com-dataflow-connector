 ...
 *
 *
 * Operation: 'dataflow.projects.locations.templates.create'
 * Endpoint Path: '/v1b3/projects/{projectId}/locations/{location}/templates'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/v1b3/projects/{projectId}/locations/{location}/templates',
        method: 'post',
        parameters: parameters,
